...
public class Exercises
{
    ...
    public static int MaxNoOfAttendeesAtScottishWedding(int covidAlertLevel)
    {
        switch (covidAlertLevel)
        {
            case 4:
                return 20;
            case 3:
            ...
            case 0:
                return 200;
            default:
                throw new ArgumentOutOfRangeException("Value can only be from 0-4 inclusive");
        }
    }
